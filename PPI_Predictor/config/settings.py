"""
PPI Predictor - Configuration Settings
...
# Load .env from PPI_Predictor directory
...
# Primary PPI series (target variable)
PPI_TARGET_SERIES = "PPIACO"  # PPI All Commodities (longest history)
...
# CLASSIFICATION BINS
# ──────────────────────────────────────────────
# Bin step size for discretized PPI MoM (in percentage points)
BIN_STEP = 0.1
